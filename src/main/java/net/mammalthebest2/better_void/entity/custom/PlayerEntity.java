package net.mammalthebest2.better_void.entity.custom;
...
public class PlayerEntity extends Animal implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public PlayerEntity(EntityType<? extends Animal> p_27557_, Level p_27558_) {
