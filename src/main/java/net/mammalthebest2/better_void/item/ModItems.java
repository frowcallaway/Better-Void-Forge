...
public class ModItems {
    ...
    public static final RegistryObject<Item> VOID_SWORD = ITEMS.register("void_sword",
            () -> new WitheringSwordItem(ModTiers.EXTREME_VOID, 8,4.0f, new Item.Properties().tab(BetterVoidCreativeTab.better_void)));

    public static final RegistryObject<Item> VOID_PICKAXE = ITEMS.register("void_pickaxe",
            () -> new PickaxeItem(ModTiers.EXTREME_VOID, 3,5f, new Item.Properties().tab(BetterVoidCreativeTab.better_void)));

    public static final RegistryObject<Item> VOID_AXE = ITEMS.register("void_axe",
            () -> new AxeItem(ModTiers.EXTREME_VOID, 2,4f, new Item.Properties().tab(BetterVoidCreativeTab.better_void)));

    public static final RegistryObject<Item> VOID_HOE = ITEMS.register("void_hoe",
            () -> new HoeItem(ModTiers.EXTREME_VOID, 0,0f, new Item.Properties().tab(BetterVoidCreativeTab.better_void)));

    public static final RegistryObject<Item> VOID_SHOVEL = ITEMS.register("void_shovel",
            () -> new ShovelItem(ModTiers.EXTREME_VOID, 0,0f, new Item.Properties().tab(BetterVoidCreativeTab.better_void)));

    public static final RegistryObject<Item> VOID_HELMET = ITEMS.register("void_helmet",
            () -> new ArmorItem(ModArmorMaterials.EXTREME_VOID, EquipmentSlot.HEAD, new Item.Properties().tab(BetterVoidCreativeTab.better_void)));
    ...
    public static final RegistryObject<Item> VOID_BOOTS= ITEMS.register("void_boots",
            () -> new ArmorItem(ModArmorMaterials.EXTREME_VOID, EquipmentSlot.FEET, new Item.Properties().tab(BetterVoidCreativeTab.better_void)));
